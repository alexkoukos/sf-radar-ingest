...
2. `DELETE FROM groups WHERE group_slug IN (...)` for the throwaway proof groups: `f9d9b79a2a15799ff088ddded2dcc692`, `9b19f63b6fc2fe97ff057a3aab7d8e9e`, `e7dd448dc021960ac54fd48d10481240`, `cd3d84b8e5fc22aa79d1be659574a5dd`, `bf3f3c8a2153df1f4395ed9cf57a9d7d`, `b08cf7dbf2759c0e62433b439f5f6265`, `5cca1c8975e22c1c7fd7e6e45297c6e4` (007-client rename+busy-URL proof — also `DELETE FROM plans WHERE slug = 'proof6cddd1eecf36a4656b78'`), `ee2f7f0aae9afe91e617b8f6573a62b8` (user asked to delete this one to start fresh; no group-delete endpoint exists, so it needs service-role SQL). Some earlier ones may already be gone.
